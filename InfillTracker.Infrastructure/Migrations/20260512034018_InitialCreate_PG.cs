        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaskOwnerId = table.Column<int>(type: "integer", nullable: true),
                    VendorId = table.Column<int>(type: "integer", nullable: true),
                    ExcelCode = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    ProjectStage = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: true),
                    ...
                    TypicalTimelineDays = table.Column<int>(type: "integer", nullable: true),
                    OwnerStartDate = table.Column<DateOnly>(type: "date", nullable: true),
                    FinishDate = table.Column<DateOnly>(type: "date", nullable: true),
                    TotalActualDays = table.Column<int>(type: "integer", nullable: true),
                    ...
                    TemplateDocument = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NotificationLogs_Tasks_TaskId",
                        column: x => x.TaskId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NotificationLogs_TaskId_EventType_SentTo_SentAt",
                table: "NotificationLogs",
                columns: new[] { "TaskId", "EventType", "SentTo", "SentAt" });
